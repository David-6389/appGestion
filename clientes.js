...
export async function guardarCliente() {
    ...
    if (emailExistente) {
     ...
     try {
        if (clienteEditandoId) {
            ...
            // Modo nuevo - Crear nuevo cliente
    ...
    // Generar ID temporal (luego vendrá del backend)
    //cliente.id = 'cliente_' + Date.now();
    
    // Agregar a los datos
    //estadoApp.datos.clientes.push(cliente);
...
// export async function actualizarClienteExistente(datosCliente) {
//     const index = estadoApp.datos.clientes.findIndex(c => c.id === clienteEditandoId);
    
//     if (index !== -1) {
//         // Mantener el ID y fecha de registro original
//         estadoApp.datos.clientes[index] = {
//             ...estadoApp.datos.clientes[index],
//             ...datosCliente
//         };
...
//         console.log('Cliente actualizado:', estadoApp.datos.clientes[index]);
//     } else {
//         mostrarAlerta('Error: Cliente no encontrado para editar', 'danger');
//     }
// }
...
//     // Agregar a los datos
//     estadoApp.datos.clientes.push(nuevoCliente);
...
// Función para mostrar el modal de cliente (actualizada)
